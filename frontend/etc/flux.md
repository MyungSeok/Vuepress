...
Action Creator 는 라이브러리에서 제공하는 Helper 메서드로 메서드 파라미터에서 Action 을 생성하고 Type 을 설정하거나 Dispather 에게 제공하는 역할을 한다.
...
React 는 조화롭고 자유로운 형태로 다시 랜더링 할 수 있는 View 를 View 레이어로 제공한다.
